...
test('critical navigation labels exist in both languages',()=>{for(const l of ['ru','en']) for(const k of ['home','players','dungeon','heroes','titans','guildVs','about']) assert.ok(translations[l][k])});
